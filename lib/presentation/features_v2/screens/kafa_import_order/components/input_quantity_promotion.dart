...
class InputQuantityPromotion extends StatelessWidget {
  const InputQuantityPromotion({super.key, this.changeAmount, required this.amountTec, required this.item, required this.focusNode});

  final TextEditingController amountTec;
  final Function(PromotionItemDataModel, int)? changeAmount;
  final PromotionItemDataModel item;
