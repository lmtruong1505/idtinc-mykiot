...
class _SupplierListPageState extends State<SupplierListPage> {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      appBar: BaseAppBar(title: 'Danh sách nhà cung cấp', actions: [
        InkWell(
            onTap: () async {},
            child: Container(
        ...
        InkWell(
            onTap: () async {
              await context.router.push(SupplierUpdateRoute());
          ...
          child: BlocProvider<SupplierCubit>(
              ...
              child: BlocBuilder<SupplierCubit, SupplierState>(
                  builder: (context, state) => Column(children: [
                        Row(children: [
                          Expanded(
                              child: Text("Tổng số NCC: ${state.total}",
  ...
  Widget _oneItem(SupplierEntity item) => GestureDetector(
        onTap: () async {
          await context.router.push(SupplierDetailRoute(id: item.id!));
          myBloc.entityILC.onRefresh();
        },
        child: Container(
            ...
            child: Column(children: [
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('Mã nhà cung cấp: ${item.code}',
                      style: p5.copyWith(color: blackColor)),
                  Text('Tên nhà cung cấp: ${item.name}',
              ...
              gapHeight(sp12),
              RowItem(title: 'Đại diện nhà cung cấp', content: item.deputyName),
              gapHeight(sp12),
              RowItem(title: 'Đơn nhập kho hoàn thành', content: "15.000"),
              gapHeight(sp12),
              RowItem(title: 'Người tạo', content: item.deputyName),
              gapHeight(sp12),
            ])),
      );
}
