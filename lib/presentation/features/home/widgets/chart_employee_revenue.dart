...
class ChartEmployeeRevenue extends StatefulWidget {
  const ChartEmployeeRevenue({super.key, required this.cubit});

  final HomeCubit cubit;

  @override
  State<ChartEmployeeRevenue> createState() => _ChartEmployeeRevenueState();
}

class _ChartEmployeeRevenueState extends State<ChartEmployeeRevenue> {
  @override
