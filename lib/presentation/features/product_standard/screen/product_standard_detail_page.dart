...
@RoutePage()
class ProductStandardDetailPage extends StatefulWidget {
  final int id;
  const ProductStandardDetailPage({super.key, required this.id});

  @override
  State<ProductStandardDetailPage> createState() =>
      _ProductStandardDetailPageState();
}

class _ProductStandardDetailPageState extends State<ProductStandardDetailPage> {
  final myBloc = getIt.get<ProductStandardCubit>();
  @override
  Widget build(BuildContext context) => Scaffold(
        appBar: BaseAppBar(title: 'Chi tiết tiêu chuẩn sản xuất', actions: [
          InkWell(
              onTap: () async {
                await context.router
                    .push(ProductStandardUpdateRoute(id: widget.id));
                ...
                child: BlocBuilder<ProductStandardCubit, ProductStandardState>(
                  ...
                  return SingleChildScrollView(
                    ...
                    child: Column(children: [
                      Container(
                          ...
                          child: Column(children: [
                            Container(
                                ...
                                child: Text('Thông tin tiêu chuẩn sản xuất',
                                    style: p3)),
                            ...
                            Container(
                                alignment: Alignment.centerLeft,
                                child: Text(state.item.description, style: p6)),
                            gapHeight(sp12),
                            RowItem(
                                title: 'Người tạo',
                      ...
                      gapHeight(sp16),
                      BlocBuilder<ProductStandardCubit, ProductStandardState>(
                          builder: (context, state) {
                        return SingleChildScrollView(
                            controller: myBloc.scrollController,
                            child: Column(children: [
