...
@RoutePage()
class ProductCompanyListPage extends StatefulWidget {
  @override
  State<ProductCompanyListPage> createState() => _ProductCompanyListPageState();
}

class _ProductCompanyListPageState extends State<ProductCompanyListPage> {
  final myBloc = getIt.get<ProductCompanyCubit>();
  @override
  Widget build(BuildContext context) => Scaffold(
      backgroundColor: bg_5,
      appBar: BaseAppBar(title: 'Danh sách công ty sản xuất', actions: [
        InkWell(
            onTap: () async {},
            child: Container(
        ...
        InkWell(
            onTap: () async {
              await context.router.push(ProductCompanyUpdateRoute());
  ...
  Widget _oneItem(ProductCompanyEntity item) => GestureDetector(
        onTap: () async {
          await context.router.push(ProductCompanyDetailRoute(id: item.id!));
          myBloc.entityILC.onRefresh();
        },
        child: Container(
            ...
            child: Column(children: [
              ...
              Container(
                  ...
                  child: Text(item.address,
                      style: p5.copyWith(color: blackColor))),
              gapHeight(sp12),
              RowItem(title: 'Nước sản xuất', content: item.country),
              gapHeight(sp12),
