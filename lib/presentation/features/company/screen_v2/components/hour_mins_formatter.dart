...
class HourMinsFormatter extends TextInputFormatter {
  ...
  String pack(String value) {
    ...
    // final left = int.tryParse(value.substring(0, 2)) ?? 0;
    // final right = int.tryParse(value.substring(2, 4)) ?? 0;

    // return '${left > 23 ? "23" : value.substring(0, 2)}:${right > 59 ? "59" : value.substring(2, 4)}';
