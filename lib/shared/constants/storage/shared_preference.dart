...
class AppSharedPreference {
  ...
  Future<void> clearByMode() async {
    const modeEnv = String.fromEnvironment('MODE', defaultValue: 'dev');
    final mode = preferences.getString(PrefKeys.mode);
    print('MODE: $modeEnv  ==  LOCAL_MODEL: $mode');
    if (mode == modeEnv) {
      return;
    }
    await preferences.clear();
    preferences.setString(PrefKeys.mode, modeEnv);
  }
}
